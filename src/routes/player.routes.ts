...
router.put(
  ...
  updatePlayerProfileValidation,
  validate,
  playerController.updateMyProfile,
);
...
router.get(
  ...
  getPlayerSessionsValidation,
  validate,
  playerController.getMySessions,
);
...
router.get(
  ...
  getPlayerObligationsValidation,
  validate,
  playerController.getMyObligations,
);
router.get(
  "/obligations/:obligationId",
  obligationIdParamValidation,
  validate,
  playerController.getObligationDetails,
);
router.post(
  "/obligations/:obligationId/pay",
  markAsPaidValidation,
  validate,
  playerController.markAsPaid,
);
...
router.get(
  ...
  paymentIdParamValidation,
  validate,
  playerController.getPaymentStatus,
);
router.post(
  "/payments/:paymentId/proof",
  paymentIdParamValidation,
  validate,
  playerController.uploadPaymentProof,
);
router.post(
  "/payments/:paymentId/proof/resubmit",
  paymentIdParamValidation,
  validate,
  playerController.resubmitProof,
);
...
router.delete(
  ...
  faceEmbeddingIdValidation,
  validate,
  playerController.deleteFaceEnrollment,
);
