...
// GET /api/player/me
// =====================================
export const getMyProfile = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
...
// PUT /api/player/me
// =====================================
export const updateMyProfile = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
        const { name, email, phone, photoUrl } = req.body as PlayerProfileUpdateInput;
...
// =====================================
export const getMySessions = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
...
// =====================================
export const getMyObligations = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
        const { status = 'all' } = req.query as { status?: string };
        ...
        const summary = {
            ...
            paid: obligations.filter((o) => o.status !== ObligationStatus.PENDING).length,
        };

        sendSuccess(res, 'Obligations retrieved successfully', { obligations: items, summary });
    } catch (error) {
...
// =====================================
export const getObligationDetails = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
        ...
        if (obligation.payerId !== playerId) {
            sendError(res, 'Permission denied', [
                { field: 'obligation', message: 'This obligation belongs to another player' },
            ], 403);
            return;
        }
...
// =====================================
export const markAsPaid = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
        const { obligationId } = req.params;
        ...
        if (obligation.status !== ObligationStatus.PENDING && obligation.status !== ObligationStatus.REJECTED) {
            sendError(res, 'Already paid', [
                { field: 'status', message: 'This obligation is already marked as paid' },
            ], 409);
            return;
        }
...
// =====================================
export const uploadPaymentProof = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
...
// =====================================
export const getPaymentStatus = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
        const { paymentId } = req.params;
...
// =====================================
export const resubmitProof = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
...
// =====================================
export const enrollFace = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
...
// =====================================
export const deleteFaceEnrollment = async (req: PlayerAuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const playerId = req.playerId;
